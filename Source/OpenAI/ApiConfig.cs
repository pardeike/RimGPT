...
namespace OpenAI
{
	...
	public static class ApiExtensions
	{
		...
		/// <summary>
		/// Updates a single ApiConfig in list.
		/// </summary>
	...
	public class ApiEndpoints(ApiConfig apiConfig)
	{
		...
		/// <summary> ListModels Endpoint: "/models" or "/tags" for Ollama </summary>
		...
		/// <summary> RetrieveModel Endpoint: "/models/{id}" </summary>
		/// <param name="id">Model ID</param>
		public string RetrieveModel(string id) => Combine($"/models/{id}");

		/// <summary> CreateCompletion Endpoint: "/completions" </summary>
		public string CreateCompletion => Combine("/completions");

		/// <summary> CreateChatCompletion Endpoint: "/chat/completions" or "/chat" for Ollama </summary>
		public string CreateChatCompletion => apiConfig.Provider switch
		{
			ApiProvider.Ollama => Combine("/chat"),
			_ => Combine("/chat/completions")
		};
		/// <summary> CreateEdit Endpoint: "/edits" </summary>
		public string CreateEdit => Combine("/edits");

		/// <summary> CreateImage Endpoint: "/images/generations" </summary>
		public string CreateImage => Combine("/images/generations");

		/// <summary> CreateImageEdit Endpoint: "/images/edits" </summary>
		public string CreateImageEdit => Combine("/images/edits");

		/// <summary> CreateImageVariation Endpoint: "/images/variations" </summary>
		public string CreateImageVariation => Combine("/images/variations");

		/// <summary> CreateEmbeddings Endpoint: "/embeddings" </summary>
		public string CreateEmbeddings => Combine("/embeddings");

		/// <summary> CreateAudioTranscription Endpoint: "/audio/transcriptions" </summary>
		public string CreateAudioTranscription => Combine("/audio/transcriptions");

		/// <summary> CreateAudioTranslation Endpoint: "/audio/translations" </summary>
		public string CreateAudioTranslation => Combine("/audio/translations");

		/// <summary> ListFiles Endpoint: "/files" </summary>
		public string ListFiles => Combine("/files");

		/// <summary> CreateFile Endpoint: "/files" </summary>
		public string CreateFile => Combine("/files");

		/// <summary> DeleteFile Endpoint: "/files/{id}" </summary>
		...
		/// <summary> DownloadFile Endpoint: "/files/{id}/content" </summary>
		/// <param name="id">File ID</param>
		public string DownloadFile(string id) => Combine($"/files/{id}/content");

		/// <summary> CreateFineTune Endpoint: "/fine-tunes" </summary>
		public string CreateFineTune => Combine("/fine-tunes");

		/// <summary> ListFineTunes Endpoint: "/fine-tunes" </summary>
		public string ListFineTunes => Combine("/fine-tunes");

		/// <summary> RetrieveFineTune Endpoint: "/fine-tunes/{id}" </summary>
		/// <param name="id">Fine-tune job ID</param>
		public string RetrieveFineTune(string id) => Combine($"/fine-tunes/{id}");

		/// <summary> CancelFineTune Endpoint: "/fine-tunes/{id}/cancel" </summary>
		/// <param name="id">Fine-tune job ID</param>
		public string CancelFineTune(string id) => Combine($"/fine-tunes/{id}/cancel");

		/// <summary> ListFineTuneEvents Endpoint: "/fine-tunes/{id}/events?stream={stream}" </summary>
		/// <param name="id">Fine-tune job ID</param>
		...
		/// <summary> DeleteFineTunedModel Endpoint: "/models/{model}" </summary>
		/// <param name="model">Model ID</param>
		public string DeleteFineTunedModel(string model) => Combine($"/models/{model}");

		/// <summary> CreateModeration Endpoint: "/moderations" </summary>
