...
namespace OpenAI
{
    ...
    public struct ListModelsResponse : IResponse
    {
        ...
        // Ollama specific properties, mapping models.name to the data.id property
        ...
        public List<OpenAIModel> Models
        {
            ...
            {
                _models = value;
                // Map 'Name' to 'Id' and assign the list to Data
                Data = _models.ConvertAll(m => new OpenAIModel
                {
                    Id = m.Name
                });
            }
    ...
    public struct ChatChoice
    {
        ...
        /// <summary>
        /// For chat streaming only. A chat completion delta generated by streamed model responses.
        /// </summary>
